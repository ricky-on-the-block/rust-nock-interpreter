pub mod nock_4k {
    ...
    // Current implementation clones 15,066 times for the decrement-test
    ...
    impl Noun {
        ...
        // pub fn cellref(left: &Noun, right: &Noun) -> Self {
        ...
        fn clone(&self) -> Self {
            ...
            let cloned = match self {
                ...
                Noun::Cell(left, right) => Noun::Cell(Box::new(left.as_ref().clone()), Box::new(right.as_ref().clone())),
            };

            println!("Cloning Noun. Clone count: {}. New value at: {:p}", count + 1, &cloned as *const Noun);
