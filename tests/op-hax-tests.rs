...
//         let mut original = Noun::Cell(Box::new(Noun::Atom(22)), Box::new(Noun::Atom(33)));
//         let replacement = Noun::Atom(11);
//         let result = hax(&Noun::Atom(1), &replacement, &mut original);
...
//         let mut original = Noun::Cell(Box::new(Noun::Atom(22)), Box::new(Noun::Atom(33)));
//         let replacement = Noun::Atom(11);
//         let result = hax(&Noun::Atom(2), &replacement, &mut original);
...
//         let mut original = Noun::Cell(Box::new(Noun::Atom(22)), Box::new(Noun::Atom(33)));
//         let replacement = Noun::Atom(11);
//         let result = hax(&Noun::Atom(3), &replacement, &mut original);
...
//         );
//         let replacement = Noun::Atom(11);
//         let result = hax(&Noun::Atom(4), &replacement, &mut original);
...
//         );
//         let replacement = Noun::Atom(11);
//         let result = hax(&Noun::Atom(5), &replacement, &mut original);
//         let expected = Noun::Cell(
//             Box::new(Noun::Cell(
//                 Box::new(Noun::Atom(22)),
//                 Box::new(Noun::Atom(11)),
