...
fn test_tar_operator_4_nested_increment() {
    let mut input = noun![[10 20] [4 [0 2]]];
    let result = tar(&mut input);
...
fn test_tar_operator_4_overflow() {
    let mut input = noun![18_446_744_073_709_551_615u64 [4 [0 1]]];
    let result = tar(&mut input);
